...
Game.prototype.endGame = function() {
  if (this.player1.score > this.player2.score) {
    this.player1.emit('victory', "You won with " + this.player1.score + " points. Your opponent had " + this.player2.score + " points");
    this.player2.emit('victory', "You lost with " + this.player1.score + " points. Your opponent earned " + this.player2.score + " points");
  } else if (this.player2.score > this.player1.score) {
    this.player2.emit('victory', "You won with " + this.player2.score + " points. Your opponent had " + this.player1.score + " points");
    this.player1.emit('victory', "You lost with " + this.player2.score + " points. Your opponent earned " + this.player1.score + " points");
  } else {
