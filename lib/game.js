...
Game.prototype.draw = function() {
  ...
  self = this;
  if (this.cards.length == 0) {
    this.io.to(this.room).emit('game message', "No points awarded this round.");
    this.endGame();
  } else {
...
Game.prototype.endGame = function() {
  if (this.player1.score > this.player2.score) {
    this.player1.emit('end game', "You won with " + this.player1.score + " points. Your opponent had " + this.player2.score + " points");
    this.player2.emit('end game', "You lost with " + this.player1.score + " points. Your opponent earned " + this.player2.score + " points");
  } else if (this.player2.score > this.player1.score) {
    this.player2.emit('end game', "You won with " + this.player2.score + " points. Your opponent had " + this.player1.score + " points");
    this.player1.emit('end game', "You lost with " + this.player2.score + " points. Your opponent earned " + this.player1.score + " points");
  } else {
