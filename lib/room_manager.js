...
RoomManager.prototype.assignRoom = function(socket) {
  if (this.unmatchedSockets.length == 0) {
    ...
    socket.emit('game message', "Waiting to match you with an opponent. You may want to ask a friend to play or, to demo the application, open it in another browser window.");
  } else {
